			...
			<div class="container">
				<div class="row">
					...
					<div class="booking-form">
						<form:form action="/user/editbooking" method="post" modelAttribute="booking">
							<div>
							<h2 style="text-align: center"> Edit Your Reservation</h2></div>
							<p style="color:red">${bookerror}</p>
							<div class="form-group">
								<input class="form-control" id ="uname" placeholder="${sessionScope['loggedUser']['username']}" readonly/>
								<span class="form-label">Name</span>
							</div>
							
							<form:input path="id" value="${bid}" hidden="hidden"/>
							<div class="form-group">
							...
							<div id="butn">
								<form:button type="button home-button" id="button1" >Edit Booking</form:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
