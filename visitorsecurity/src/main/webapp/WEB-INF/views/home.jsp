...
<h2 style="text-align:center; color:#AFEEEE"><strong>Booking Info</strong></h2>
...
<br><br>
<div id="butn">
	<button onclick="window.location.href='/user/newbooking'" id="button3" >New Booking</button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
